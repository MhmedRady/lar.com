    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item"><a href=""><i class="la la-language"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">اللغات المفعله </span>
                    <span
                        class="badge badge badge-dark badge-pill float-right mr-2">{{App\Models\Language::active()->count()}}</span>
                </a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route("newLang")}}" data-i18n="nav.dash.crypto">أضافة
                            لغة جديدة</a>
                    </li>
                    <li class="active">
                        <a class="menu-item" href="{{route("all.admin.langS")}}"
                          data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item"><a href=""><i class="la la-sticky-note-o"></i>
                    <span class="menu-title" data-i18n="nav.dash.main"> المتاجر الرئيسية</span>
                    <span
                        class="badge badge badge-info badge-pill float-right mr-2">{{App\Models\MainCategory::active()->count()}}</span>
                </a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route("newMCategories")}}"
                        data-i18n="nav.dash.crypto">أضافة
                            قسم جديد </a>
                    </li>
                    <li class="active"><a class="menu-item" href="{{route("all.admin.MCategories")}}"
                       data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                </ul>
            </li>
