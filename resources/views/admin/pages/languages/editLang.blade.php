                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route("setUpdateLang",$LangS->id)}}" method="POST"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$LangS->default}}"
                                                                   id="default"
                                                                   class="form-control"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{$LangS->abbr}}" id="abbr"
                                                                   class="form-control"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="direction" name="direction"
                                                                ...
                                                                <optgroup label="من فضلك أختر اتجاه اللغة ">
                                                                    <option @if($LangS->direction=="rtl") {{"selected"}} @endif value="rtl">من اليمين الي اليسار</option>
                                                                    <option @if($LangS->direction=="ltr") {{"selected"}} @endif value="ltr">من اليسار الي اليمين</option>
                                                                </optgroup>
                                                            </select>
                                                            @error("direction")
                                                                <span class="text-danger"> {{$message}} </span>
